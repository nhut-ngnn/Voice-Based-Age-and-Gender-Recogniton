...
from lstm_gender_model import lstm_gender_model
from lstm_age_model import lstm_age_model
...
data_path = "C:/Users/admin/Documents/Voice_Based_Age_Gender_and_Emotion/New_Project/audio/"
models_path = "C:/Users/admin/Documents/Voice_Based_Age_Gender_and_Emotion/New_Project/model1/"
...
def main_program():
    ...
    gender_weights, gender_means, gender_stddev = get_data_files(models_path, "gender", 15)
    age_weights, age_means, age_stddev = get_data_files(models_path, "age", 60)
    ...
    for data_file in data_files:
        data = get_audio_features(Path(data_path + data_file),
                                  extra_features=["delta", "delta2", 'pitch','constract'])
